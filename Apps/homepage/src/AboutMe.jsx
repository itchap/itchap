    ...
    <div style={{ backgroundColor: theme.bg, minHeight: '100vh', padding: '60px 20px', color: theme.textMain, fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ backgroundColor: theme.cardBg, border: `1px solid ${theme.border}`, borderRadius: '8px', padding: '40px', marginTop: '20px' }}>
            <h4 style={{ color: '#fff', fontSize: '24px', margin: '0 0 20px 0', textAlign: 'center' }}>Publications</h4>
            <div style={{ maxWidth: '800px', margin: '0 auto', backgroundColor: 'rgba(255, 255, 255, 0.03)', padding: '25px', borderRadius: '12px', border: `1px solid #444` }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '10px' }}>
                <h5 style={{ margin: '0 0 10px 0', fontSize: '18px', color: theme.accent, flex: 1 }}>
                  Pre-emptive Cloud Auto-scaling Influenced by Social Network Trends
                </h5>
                <a 
                  href="https://ieeexplore.ieee.org/document/8374456" 
                  target="_blank" 
                  ...
                  onMouseOver={(e) => { e.target.style.backgroundColor = theme.accent; e.target.style.color = '#000'; }}
                  onMouseOut={(e) => { e.target.style.backgroundColor = 'transparent'; e.target.style.color = theme.accent; }}
                >
                  View on IEEE Xplore ↗
                </a>
              </div>
              <p style={{ fontSize: '14px', color: '#fff', fontWeight: 'bold', marginBottom: '10px' }}>
                Published in: 2017 IEEE 10th International Conference on Cloud Computing (CLOUD)
              </p>
              <p style={{ fontSize: '14px', color: theme.textSub, lineHeight: '1.6', margin: 0 }}>
                This research presents a novel architecture for pre-emptive cloud auto-scaling. By analyzing social network sentiment and trend velocity, the system can predict traffic spikes before they hit the application layer, allowing for resource provisioning that prevents latency issues associated with reactive scaling models.
              </p>
            </div>
          </div>
