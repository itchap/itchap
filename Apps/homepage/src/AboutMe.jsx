      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px' }}>
            ...
            {/* 5. Newbay Software */}
            <div style={{ backgroundColor: theme.cardBg, border: `1px solid ${theme.border}`, borderRadius: '8px', padding: '30px', textAlign: 'center' }}>
              <img src="https://images.crunchbase.com/image/upload/c_pad,h_256,w_256,f_auto,q_auto:eco,dpr_1/v1397196480/6d953c97914c01d75fe1937767a3553b.png?ik-sanitizeSvg=true" alt="Newbay Software" style={{ height: '70px', marginBottom: '15px', opacity: 0.6, filter: 'grayscale(100%) brightness(1.5)' }} />
